...
export const ViewMyMedicalHistoryPage: React.FC = () => {
    ...
    return (
        <div className="w-full min-h-full flex flex-col gap-4 sm:gap-6">
            ...
            {isError && (
                <div className="rounded-xl border border-rose-200 dark:border-rose-800 bg-rose-50 dark:bg-rose-950/50 p-4 text-sm text-rose-700 dark:text-rose-300">
                    ...
                    {errorMessage?.includes("Acceso denegado") && (
                        <div className="mt-3 p-3 bg-rose-100 dark:bg-rose-900/50 rounded">
                            <p className="font-medium text-rose-800 dark:text-rose-200">Posible solución:</p>
            ...
            {!currentPatientId && !isLoading && (
                <div className="rounded-xl border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-950/50 p-4 text-sm text-amber-700 dark:text-amber-300">
